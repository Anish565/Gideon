...
from wx.core import ALIGN_CENTER, Button
...
app = wx.App()
frame = wx.Frame(parent=None,title = "Gideon")
frame.SetIcon(wx.Icon("icons/GideonIcon.ico"))
# frame.SetIcon(plane.GetIcon())
panel = wx.Panel(frame)
my_sizer = wx.BoxSizer(wx.VERTICAL)


activate = wx.Button(panel, label="Tap to speak")
activate.Bind(wx.EVT_BUTTON, CommandActive)
my_sizer.Add(activate, 0, wx.ALL | wx.EXPAND, 5)
